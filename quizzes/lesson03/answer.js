...
window.addEventListener("DOMContentLoaded", function() {
  ...
  fetchAsAudioBuffer(audioContext, "assets/piano-high.wav", function(audioBuffer) {
    instruments[0] = audioBuffer;
  });
  fetchAsAudioBuffer(audioContext, "assets/piano-mid.wav", function(audioBuffer) {
    instruments[1] = audioBuffer;
  });
  fetchAsAudioBuffer(audioContext, "assets/piano-low.wav", function(audioBuffer) {
    instruments[2] = audioBuffer;
  });
